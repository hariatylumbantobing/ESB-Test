...
WebUI.setText(findTestObject('Page_Login-logout/input_Username'), findTestData('Login Creds').getValue(1, 2))

WebUI.verifyElementPresent(findTestObject('Page_Login-logout/div_Password'), 1)

WebUI.setText(findTestObject('Page_Login-logout/input_Password'), findTestData('Login Creds').getValue(2, 2))
